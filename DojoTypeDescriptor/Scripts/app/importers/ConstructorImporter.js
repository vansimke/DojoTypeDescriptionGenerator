...
(function (app) {
    (function (importers) {
        ...
        var ConstructorImporter = (function (_super) {
            __extends(ConstructorImporter, _super);
            function ConstructorImporter() {
                _super.apply(this, arguments);
            }
            ConstructorImporter.prototype.importObject = function (data, callback) {
                var _this = this;
                var result = new app.model.DojoConstructor();
            ...
            ConstructorImporter.prototype.importBaseClasses = function (result, content) {
            ...
            return ConstructorImporter;
        })(importers.BaseImporter);
        importers.ConstructorImporter = ConstructorImporter;
    })(app.importers || (app.importers = {}));
    var importers = app.importers;
})(app || (app = {}));
//# sourceMappingURL=ConstructorImporter.js.map
